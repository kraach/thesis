...
The wafer naming convention was "frequency band"-"wafer's position in the fabrication sequence", e.g. 250-04. 
%The characterization measurements provided here are only for those wafers which flew in the \ac{EBEX2013} flight.  %not true
