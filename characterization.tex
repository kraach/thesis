...
The upper panel of Figure~\ref{fig:timestream_and_psd} is an example of a raw bolometer timestream converted to A for wafer~150-01 bolometer~3-01 as a function of sample number (there were 20MHz/$2^{17} = 190.73 samples per second).
...
\caption{The raw bolometer timestream converted from \ac{ADC} counts to current and the square root of the PSD for wafer~150-01 bolometer 3-01 noise determination. The timestream was $\sim3$ minutes long. The white noise level was averaged from 0.5 to 5~Hz and for this bolometer had a value of 11.2 pA. 
