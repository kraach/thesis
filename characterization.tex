...
Figure~\ref{fig:770mK_squid_noise} is the 770~mK measured and predicted noise both on and off bolometer resonant frequenices, still with no carrier or nuller biases.
...
At the higher off-resonance demodulation frequencies, however, the noise was at the level of the on-resonance prediction, 45\% above the off-resonance prediction.
Though we expected increased cross-talk given the larger detector resistance in this configuration, it didn't explain the level of excess noise we measured off-resonance. 
