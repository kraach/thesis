...
The \ac{ETC} had three Fairchild IR LED56's, with a wavelength of 940 nm, mounted to the lid of the wafer enclosure, directly above the detectors. 
...
We assume the response is a single pole roll off and the time constant is taken as the -3dB point, Table~\ref{tab:optical_tau}. 
...
\end{tabular}
\end{center}
\caption{IR LED time constants for one comb of bolometers on 150-02, dark in \ac{ETC}, dropped to 80\% of their initial resistance. 
