...
\begin{figure}[ht!]
\begin{center}
\includegraphics[height=2.5in]{figures/EBEX_Nb01_150GHz_wafer_schem.pdf}
\caption{x8 wafer layout for wafer~150-01. Squids are grouped by different color. Inside the pink circle are the detectors open to the blackbody. 
