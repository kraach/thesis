...
Figure~\ref{fig:network_analysis} is a network analysis for a single comb of 15 detectors. 
...
\caption{The fit of network analysis peak (blue solid) and the optimal bias frequency determined (green dot).
\label{fig:network_analysis} }
\end{center}
\end{figure}
