...
The electronic noise predictions, specifically the noise due to the first stage amplifier and the 20~$\Omega$ resistor on the \ac{SQUID} controller board, required a measure of the \ac{SQUID} transimpedance, $dV/dI$. 
