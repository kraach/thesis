...
\begin{figure}[ht!]
\begin{center}
\includegraphics[height=2.5in]{figures/vphi.png}
\caption{\ac{SQUID} voltage versus flux curve. The operating regime is highlighted (red) and fit to a line (orange) to get the \ac{SQUID} transimpedance, $dV/d\phi$.
\label{fig:squid_transimpedance} }
\end{center}
\end{figure}

[-7.48092816  2.54458819]
