...
\caption{Left: An 800~mK network analysis from wafer 150-17. The blue line has frequency steps of 10~kHz to roughly locate the peaks and the orange dots are the finer scans with steps of 1~kHz to obtain the data to fit. Right: The Lorentzian fit (blue line) to a single peak (red dots). The fit provides the bolometer resonant frequency (green dot), the bolometer normal resistance, and the circuit's stray inductance and stray capacitance. 
