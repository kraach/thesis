...
The IV and PV curves for a detector two rows away from the detectors open to the blackbody are shown in Figure~\ref{fig:dark_pelec_vs_popt}. 
This detector had a measured optical efficiency of $\sim$10\%. 
%YOU CAN'T JUST GIVE ONE NUMBER FOR ONE DETECTOR. CAN YOU CALCULATE THE AVERAGE AND STANDARD DEVIATION, PLEASE? 
