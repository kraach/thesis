...
\caption{Left: The current through the \ac{SQUID} as function of the voltage bias across the bolometer. Right: The electrical power dissipated in the bolometer ($I \times V$) as function of the voltage bias across the bolometer. The bolometer is said to be at turnaround when the slope of the IV curve is zero. The power at turnaround is 2.1~pW. If the the slope of the PV curve becomes zero deep in the transition, then that value it levels off at is often called the saturation power. We approximate the saturation power as the last point in the detector's PV curve, 1.9~pW. \textcolor{red}{I wish you could find or rewrite the code to make these figures - the pW are in square brackets and all the others in parenthesis. and the axis labels are smaller than I want them to be.}
