...
\caption{The "resistance" of a 150-01 bolometer ($I \over V$) as a function of the voltage bias across the bolometer. This bolometer was dropped to 0.7 of the starting value. 
...
Once the bolometer was sufficiently far into the superconducting transition, electro-thermal feedback caused the power dissipated in the bolometer to remain fixed, \textcolor{red}{referenceSectionOnBolometerTheory}.
