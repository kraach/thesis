...
\caption[Bolometer resistance versus voltage curve]{The instantaneous resistance ($I \over V$) of a 150-01 bolometer as a function of the voltage bias across the bolometer. This bolometer was dropped to 0.6 of the starting value. 
...
There is a more thorough measurement and analysis of optical time constants as a function of observation frequency band reported in Table~\ref{tab:Design_Params} and discussed in EBEX Paper 2 \ref{EBEXPaper2}. 
