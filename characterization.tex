...
\caption{Electronic and \ac{SQUID} noise in \ac{ETC} as function of demodulation frequency. At bolometer resonant frequencies, the Johnson noise term of the bolometer roughly doubles the noise.
