...
With the detectors at a temperature of 4.2~K, and without providing carrier or nuller biases, we measured the noise of the warm electronics and the \ac{SQUID}s as a function of demodulation frequency, Figure~\ref{fig:dark_squid_noise}. 


Demodulating at the bolometer resonant frequencies gives a measure of the 4.2~K bolometers' Johnson noise in addition to the electronic and \ac{SQUID} noise. 
This roughly doubles the noise. 
...
\caption{Electronic and \ac{SQUID} noise in \ac{ETC} as a function of demodulation frequency. Off resonance (o's) is just electronic and \ac{SQUID} noise, while on resonance (x's) includes the 4.2~K bolometer Johnson noise. 
