...
This value of $G$, however, needs to be sufficiently high to allow for the detectors to operate in the presence of the expected radiative load as well as any fluctuations in load, \textcolor{red}{referenceSectionAboutTargets}. 
...
Then we use \textcolor{red}{EquationThatDoesn'tExistYet} to relate $\overline G$ to $G$. 
