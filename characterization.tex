...
For characterization measurements, we mounted the wafer, Section~\ref{sec:}, coupled it to the readout electronics, Section~\ref{}, and cooled it to sub-Kelvin temperatures, where the exact temperature depended on the testbed. 
