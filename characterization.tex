...
Demodulating away from the bolometer resonant frequencies gives just the electronic and \ac{SQUID} noise discussed in Section~\ref{sec:squid_noise}.
...
This is unlikely to be the case because we assumed the bolometer normal resistance from the $\sim$800~mK network analysis. 
This would have actually underestimated the resistance because it increased, albeit with a shallow slope when normal, as the temperature increased. 
