...
This value of $G$, however, needs to be sufficiently high to allow for the detectors to operate in the presence of the radiative load at float, \textcolor{red}{referenceSectionAboutTargets}. 
...
Then, knowing the bath temperature, the bolometer temperature, and the power of thermal conductivity, we use \textcolor{red}{EquationThatDoesn'tExistYet} to relate our measurement of $\overline G$ to $G$. 
...
At each step, the instantaneous resistance, the ratio of the voltage bias to the current measured, was calculated. 
...
The average thermal conductance of the weak link is calculated from the saturation power, measured from the PV curve, and the critical temperature, Section~\ref{sec:critical_temp}, 
\begin{equation}
