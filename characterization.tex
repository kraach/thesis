...
Then, assuming the thermal conductivity was of the form of a power law and knowing the bath temperature, the bolometer temperature, and the power of thermal conductivity, we related our measurement of $\overline G$ to $G$ via \cite{Lee1998}
\begin{equation}
...
That is, we stepped down the voltage bias, typically in steps of 0.05~$\mu V$, and measured the current through the \ac{TES}. 
...
\end{equation}
The average thermal conductance is a function of the bath temperature and the test cryostats operated at different bath temperature than \ac{EBEX}. 
...
Then the thermal conductance at the \ac{EBEX} bath temperature, $T_{EBEX}$, is found via
\begin{equation}
G \left( T_{EBEX} \right) = something
\end{equation}
%Mention the two focal planes had different temperatures??

Histograms summarizing the measured average thermal conductance values, corrected to the \ac{EBEX} bath temperatures, for the three observation frequency bands are shown in Figure~\ref{fig:G_Histograms}.
...
The wafer box is supported by a thin (XXX) column of XXX. 
...
\begin{figure}[htp]
\begin{center}
\includegraphics[width=0.48\columnwidth]{figures/optical_efficiency_setup.jpg}
\includegraphics[width=0.48\columnwidth]{figures/hardware/opt_eff_setup_picture4.jpg}
\caption{Left: The model of the optical efficiency testbed in \ac{ETC}. Right: \textcolor{red}{While it would be lovely to have a photograph of the setup, getting this to some understandable state is probably not something you have time for.}
