...
\caption{The raw bolometer timestream converted from \ac{ADC} counts to current and the square root of the PSD for wafer~150-01 bolometer 3-01 noise determination. The timestream was $\sim3$ minutes long. The white noise level was determined by averaging the \ac{PSD} from 0.5 to 5~Hz and taking the square root. This bolometer had a noise level of 11~$pA/\sqrt{Hz}$. 
