...
\begin{equation}
P_{elec} = \overline{G} \Delta T -  \epsilon P_{BB} 
\end{equation}
Note, the slope of the line is the optical efficiency, $\epsilon$.
The right panel of Figure~\ref{fig:pelec_vs_popt} is the fit for wafer~150-01 bolometer~8-04. 
Table~\ref{tab:opt_eff} gives the slopes for all of the functioning bolometers open to the blackbody. 
