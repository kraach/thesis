...
At 770~mK, still with no carrier or nuller biases, the predicted noise included the electronic noise, \ac{SQUID} noise, and the 770~mK bolometer Johnson noise. 
...
The phonon noise contribution to the prediction here assumed the bolometer was deep in the transition. 
When the bolometer was indeed deep in the transition, the loopgain, $\mathscr{L}$, was high and so responsivity was just a function of the voltage bias, $S_{I} = \frac{\sqrt{2}}{V_{bias}} \frac{\mathscr{L}}{\mathscr{L}+1} \approx \frac{\sqrt{2}}{V_{bias}} $. 
When the bolometer was not deep in the transition, however, $\mathscr{L}$ was not large and so in this case, at high fractions of $R_{initial}$, the phonon noise contribution was UNDER/OVER-estimated. 
