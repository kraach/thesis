...
\textcolor{red}{some assumptions go into this, e.g. mutual inductance of squids, some geometry? ... you need to know what these assumptions are and you might as well write them down for posterity. this will tell you how we got from the slope (-7.48) to some number (500ish probably) with meaningful units.}

The noise predictions require a measure of the \ac{SQUID} transimpedance, $dV/d\phi$, the slope of the linear regime of the $V-\phi$ curve where we bias the squid, Figure~\ref{fig:squid_transimpedance}. 

\begin{figure}[ht!]
\begin{center}
\includegraphics[height=2.5in]{figures/squid7_transimp}
\caption{\ac{SQUID} voltage versus current curve. The operating regime is highlighted and fit to get the \ac{SQUID} transimpedance, $dV/d\phi$.
