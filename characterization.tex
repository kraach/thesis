...
In each of these cryostats, the wafer was mounted and coupled to the readout electronics as was done for flight, Section~\ref{sec:ebex}. 
...
As the fabrication procedure was modified to build detectors optimized for a space-like environment, we measured detector parameters in the dark cryostats to provide feedback to fabrication. 
...
There was also a dedicated run in \ac{ETC} to measure the optical efficiency of the 150~GHz detectors. 
