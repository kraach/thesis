...
The detector wasn't latched because we were able to re-overbias between each measurement, but the discrepancy between the measured and predicted noise increased as we dropped the detector to lower fractions of $R_{initial}$.
...
If, however, there had been an unfiltered 4.2~K radiative load incident on the detector, and the detector had an optical efficiency of 76\%, then there would have been an 
