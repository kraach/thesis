...
In the plot of the power dissipated in the bolometer ($I \times V$) as function of $V_{bias}$, the electrical power required to hold the detector in the transition is the horizontal section of the PV curve.
