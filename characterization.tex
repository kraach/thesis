...
\textcolor{red}{Also, I want you to say, in practice, how did we match the frequencies measured with the frequencies \textit{expected}? The game. The measured frequency was generally XXX\% higher than the expected one calculated from the inductance measured at 4.2~K of $24~\mu H$ and the room temperature measured capacitances. At low frequencies, the measured frequency was close to expected. At the highest frequency, however, the measured frequency was nearly 90 kHz greater than expected. }
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.98\textwidth]{figures/SqCh3_netanal.png}
