...
The noise predictions require a measure of the \ac{SQUID} transimpedance, $dV/dI$, the slope of the linear regime of the $V-\phi$ curve where we bias the squid, Figure~\ref{fig:squid_transimpedance}. 
