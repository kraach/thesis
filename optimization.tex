...
\caption{Left: One \ac{EBEX} 150~GHz spiderweb \ac{TES} bolometer. The light blue is the silicon wafer on which the detectors were fabricated. The dark blue is open space where the silicon was etched away. Running above the center of the etched out area are the thin silicon nitride strings of the spider web. The spider web is attached to the wafer at the end of each of the spokes. The gold waffle "bling" in the center provides the heat capacity and the \ac{TES} itself is a square at the bottom of the bling. Right: A zoom of the lower part of the bling and the \ac{TES}. The \ac{TES} couples to the bling via the overlap on its left side. The signal travels out the Nb leads to bond pads at the wafers' edge. Both figures are courtesy of Benjamin Westbrook. 
\label{fig:bolo_and_bling} }
\end{center}
\end{figure}

\textcolor{red}{How do I properly say this is Ben's not mine??}
