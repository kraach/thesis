...
The \ac{EBEX} bolometers were fabricated on a silicon device wafer, the thickness of which, $\lambda/4$, was determined by the observation frequency band. 
The device wafers were each glued to a thick silicon backing wafer for mechanical stability.
