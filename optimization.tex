...
We wanted to decrease $T_{c}$. 
\textcolor{red}{Why?}
The \ac{TES} was a bilayer of aluminum on the bottom and titanium on top. 
The titanium thickness was fixed at $\sim110~nm$. 
...
The average long-duration balloon floats at an altitude of $\sim120,000$~ft, above $\sim98\%$ of the atmosphere. 
The predicted load for \ac{EBEX} at float was XXX for the150~GHz observation band. 
