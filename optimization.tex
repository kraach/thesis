...
\label{eq:phonon}
\end{equation}
where $k_{B}$ is Boltzmann's constant, $T$ the temperature of the \ac{TES}, and $G \equiv dP/dT$ the dynamic thermal conductance along the weak link \cite{Mather1982}. 
