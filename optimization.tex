...
\end{equation}
Since the slope of the resistance versus temperature curve is positive for a \ac{TES}, the change in power will be opposite in sign to the change of temperature. 
This negative electrothermal feedback holds the detector at the edge of its transition. 
\textcolor{red}{ref all of the above equations??? you certainly didn't derive them.}
