...
The electronic and readout noise is noise due to fluctuations in current and voltage in the carrier, nuller, and demodulator circuits, i.e. the readout electronics. 
...
Measurements of the electronics and readout noise are discussed in Section~\ref{sec:dark_noise}.
\textcolor{red}{should we point to our noise discussions later? reference franky's thesis? and/or dfmux papers??}
