...
Quantifying the fluctuations in the absorbed energy (via boson statistics) and integrating over the radiative bandwidth, the photon \ac{NEP} is
\begin{equation}
N_{phonon}^2 = 2 \int h \nu P_{\nu} d\nu + \int \frac{P_{\nu}^{2}c^2}{A\Omega\nu^2} d\nu
\end{equation}

This is often referred to as shot noise. %except that's only the first term! 
