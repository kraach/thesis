...
The target normal resistance for all bands was 1.5~$\Omega$ in order to ensure the detector, when biased in the transition, remained in the stable regime where the detector electrical bandwidth, determined in part by the resistance, exceeded the \ac{TES} thermal bandwidth by at least XXX (CITE PAPER). THIS HAS NOTHING TO DO WITH A SPACE-LIKE ENVIRONMENT, but it does have to do with multiplexing!
...
The predicted load at float, an altitude of $\sim120,000$~ft, above $\sim98\%$ of the atmosphere, was XXX for the150~GHz observation band. 
...
The \ac{EBEX} detectors inherited their initial design from the ground-based telescope, XXX. 
In order to take advantage of the decrease in radiative load at float and increase the detector sensitivity, the fabrication goal was to lower the thermal conductance from the bolometer to the bath by a factor of XXX. 
In case of unanticipated radiative load or fluctuations, this provided a safety factor of 2.5. 
