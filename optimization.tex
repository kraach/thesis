...
Also. We needed cross-talk to be less than XXX. 
A resistance of XXX gives a crosstalk of XXX. 
...
%You wrote about this somewhere else, no? where???
...
where for \ac{EBEX} we have inductors $L_{EBEX} = 24~\mu H$ and frequency spacing of at least $\Delta \nu = 60~kHz$. %$\Delta \omega = 2\pi 60~kHz$. 
(The lower bias frequencies have this spacing, but when cooled, the lower capacitance values change more (in absolute value)and the resonant frequency spacing is larger than predicted.)
