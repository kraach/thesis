...
\end{equation}
The DC value of the loopgain is $\mathscr{L} = \frac{P_{elec}\alpha}{GT}$ and it rolls off with a time constant of $\tau = C/G$.
...
= - \frac{1}{V_{bias}} \frac{\mathscr{L}}{\mathscr{L}+1} \frac{1}{1+i\omega \tau_{eff}}
\end{equation}
...
%I LIKED MY EXPLANATION, BUT I'M NOT SURE IT IS CORRECT.
