...
Shortly after the big bang, the universe underwent a period of exponentially accelerated expansion, an epoch called inflation \cite{Linde1982}.
There is much evidence to suggest inflation is the correct model for the early universe \cite{Linde1982} \cite{Spergel2007}, yet there has been no direct observational confirmation of inflation to date.  


EBEX was built to probe the fundamental physics of inflation, which took place at the earliest conceivable time (on the order of 10-34 seconds) and at the largest of energy scales (on the order of 1015-1016 GeV).    It is my role to ensure the detectors work to the specified sensitivity, which is key to the overall experiment's ability to reach its science goals.  
EBEX was a balloon-borne cosmic microwave background radiation polarimeter. 

Science RationaleInflation predicts the existence of a stochastic background of gravitational waves which left a curl component, or 'B-mode', in the polarization of the CMB.  The energy scale of inflation is proportional to the amplitude of B-mode polarization.  If EBEX does measure B-mode polarization of the CMB, then we will have the first experimental confirmation of gravitational waves and a measure of the energy scale of inflation.  If we do not detect B-modes, then we will improve the upper limit on the tensor to scalar ratio by a factor of ~10 compared to current limits.  The tensor to scalar ratio quantifies the strength of gravity waves during inflation.  This puts an upper limit on the energy scale at which inflation occurred.  Such a limit would have significant consequences because it rules out the simplest, most favorable models of inflation.  
The \ac{CMB} radiation, the oldest light in the universe, holds a wealth of information about the evolution of the universe. 
...
In particular, the polarization patterns inform us
