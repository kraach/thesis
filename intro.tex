...
The telescope had a double window mechanism mounted to the top of the cryostat, Figure~\ref{fig:double_window}. 
On the ground, there was an additional \ac{UHMWPE} window of thickness 12.7~mm above the thin window. 
...
There were two focal planes and each focal plane consisted of seven wafers of detectors, four at 150~GHz, two at 250~GHz, and one at 410~GHz, see Figure~\ref{fig:focal_plane}.
