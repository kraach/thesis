...
Section~\ref{sec:detector_design} discusses the detector design modifications we performed to optimize the detector sensitivity for the space-like environment. 
...
The telescope had a 1.5~m primary mirror and a 1~m secondary mirror, . 
...
\begin{figure}[htbp]
\begin{center}
%\includegraphics[width=0.48\columnwidth]{figures/focal_plane_model.png}
\includegraphics[width=0.48\columnwidth]{figures/focal_plane_photo.png}
\caption[EBEX focal plane]{The silicon detector wafers wirebonded to their \ac{LC} boards. The wafer assemblies are sitting atop the gold-plated waveguide and horn array. The copper pigtails are leading off the edge of the photograph, but when fully assembled are routed through the wiring towers. The 410~GHz wafer is not included in the photograph. 
