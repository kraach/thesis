...
We predicted the in-transition \ac{NEP} in aW/$\sqrt{\mathrm{Hz}}$ at the detector. 
The in-transition noise prediction included the readout and Johnson noise, the phonon noise, and the photon noise, Equation~\ref{eq:nep}. 
Figure~\ref{fig:prediction_bar_chart} is a stacked bar chart of the \ac{EBEX} in-transition noise prediction in units of aW/$\sqrt{Hz}$ at the detector. 
