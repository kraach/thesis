...
For the 150~GHz band, if the photons were completely uncorrelated, $\xi=0$, then the photon \ac{NEP} in $W/\sqrt{Hz}$ would have decreased by a factor of $\sim$0.80, decreasing the total \ac{NEP} prediction by a factor of $\sim$0.90. 
For the 410~GHz band, the decrease in photon \ac{NEP} would have been a factor of $\sim$0.95, decreasing the total \ac{NEP} prediction by a factor of $\sim$0.98. 
