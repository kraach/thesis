...
\textcolor{red}{Then, you need to discuss results of analysis.}
...
Their purpose was to get a handle on the readout and Johnson noise by excluding the bolometer from the equation and replacing it with a known resistance. 
