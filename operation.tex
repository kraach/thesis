...
\caption[In-transition measured noise as function of time]{Top: in-transition measured (blue dots) and predicted corrected for excess noise above the transition (red crosses) \ac{NEP} for one 150~GHz detector 
...
\begin{figure}[hp]
\begin{center}
\includegraphics[hieght=2.5in]{figures/in_transition_histogram.png}
