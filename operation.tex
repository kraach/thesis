...
We look at the noise of the dark \ac{SQUID}s, the resistor channels, the bolometers over-biased while the stage is cold, and the bolometers dropped into their superconducting transition state. 
...
%The \ac{HWP} was spinning at a frequency of 1.235~Hz and so the largest component of the half-wave plate synchronious signal was at 4*$f$ = 4.94 Hz. 
%This was a sideband safely away from the 4f signal. 
%This particular frequency band was chosen because it is a polarization sideband. 

The following analysis looks at the bolometers wired to \ac{BRO}s 2, 3, and 4. 
...
Of the 941 \ac{BRO}2-4 bolometers, XXX had data which passed the valid cuts. 
