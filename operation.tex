...
\caption[Resistor noise versus time and histogram of all resistors' median noise]{Left: the resistor noise measured (red) and predicted (black dash) for one resistor throughout flight. Right: the distribution of the median measured to predicted noise for all resistor channels. The median (vertical cyan) of the distribution is 1.8. 
