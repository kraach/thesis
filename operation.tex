...
For the 150~GHz band, if the photons were completely uncorrelated, $\xi=0$, then the photon \ac{NEP} in $W^2/Hz$ would have decreased by a factor of $\sim$0.6. 
For the 410~GHz band, the decrease in photon noise would have only been a factor of $\sim$0.9. 
