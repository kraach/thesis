...
\caption[In-transition measured noise as function of time]{Top: In-transition measured (blue dots) and predicted (red crosses) \ac{NEP} for one 150~GHz detector 
throughout flight. 
...
of the measured-to-predicted \ac{NEP} ratio for this detector throughout flight. The median (vertical cyan) ratio is 1.1.
...
\caption[In-transition measured/predicted noise histogram]{The distribution of the median ratio of measured to predicted in-transition noise throughout flight for all bolometers. The predicted noise included the boost factor of 1.8 to the readout and Johnson nosie terms measured by the resistor channels. 
