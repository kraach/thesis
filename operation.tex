...
That is, for the dark test cryostat IV curve measurements, Equation~\ref{eq:pin} becomes
\be
...
\caption{Power as a function of bias voltage for a detector from a 250~GHz wafer, dark in \ac{ETC} (blue) and at float (red). The measured radiative load was 4~pW.
