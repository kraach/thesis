...
Figure~\ref{fig:radiative_load_histograms} has the distributions of the measured radiative loads from the first set of IV curves performed at float, broken down by frequency band. he measured radiative loads were Gaussian-shaped distributions. 
