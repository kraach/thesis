...
The left panel of Figure~\ref{fig:one_bolo_overbias_noise_vs_time} shows the measured and predicted overbiased noise for one 250~GHz bolometer. 
...
The right panel of Figure~\ref{fig:one_bolo_overbias_noise_vs_time} is the measured and predicted noise every 172~seconds over a $\sim$6000~second time period while the focal planes were cooling the last 50~mK to their base temperatures.
