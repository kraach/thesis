...
Though the bolometer cavity was designed to be RF-tight, we hypothesize the excess noise was due to electromagnetic pickup in the microstrips between the \ac{SQUID}s and \ac{LC} boards. 
...
Both the readout and Johnson noise have been multiplied by the excess factor of 1.8 measured by the resistors. 
The bolometer sensitivity floor was designed to be dominated by the photon noise. 
The excess measured in the electronic, readout, and Johnson noise terms, however, brought the readout noise to a level comparable to that of the photon noise. 
