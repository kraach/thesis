...
The following analysis looked at the bolometers wired to \ac{BRO}s 2, 3, and 4. 
...
In \ac{ETC}, the \ac{SQUID} noise performance was measured by looking at \ac{SQUID}s with live detectors wired to them but demodulating off-resonance. 
...
The measurement in \ac{ADC} counts was converted to current via the \ac{DfMUX} transfer functions. 
