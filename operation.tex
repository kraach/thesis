...
For the 150~GHz band, if the photons were completely uncorrelated, $\xi=0$, then the photon \ac{NEP} in $W^2/Hz$ would have decreased by a factor of $\sim$0.6, decreasing the total \ac{NEP} prediction by a factor of $\sim$0.8. 
For the 410~GHz band, the decrease in photon \ac{NEP} would have been a factor of $\sim$0.9, decreasing the total \ac{NEP} prediction by a factor of $\sim$0.95. 
