...
\comred{figure out how to properly add Mather 1982 applied optics bolometer noise paper to ebex  bibfile and reference.}
%
%
%
...
%\label{eq:current_responsivity}
%\end{equation}
%where $V_{bias}$ is the voltage bias across the bolometer, $\mathcal{L}$ is the bolometer loopgain, $\omega$ is the angular frequency of the signal modulation, and $\tau$ is the bolometer time constant~\citep{aubin_thesis}. \comred{we need to explain and/or reference why dfmux puts a $\sqrt{2}$ in the responsivity.}
